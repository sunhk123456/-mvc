<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-30 15:17:17
  from 'D:\wamp64\www\shk\2006\server\mvc\application\template\index\about.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f4bc2fda08630_85541986',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2964e212d6d20b8494f80717451d1272fbdb6d07' => 
    array (
      0 => 'D:\\wamp64\\www\\shk\\2006\\server\\mvc\\application\\template\\index\\about.html',
      1 => 1598800412,
      2 => 'file',
    ),
  ),
...
function content_5f4bc2fda08630_85541986 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
?>
                        <div class="nav-write">  <a href="<?php echo $_smarty_tpl->tpl_vars['v']->value['suoyin'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <!-- 导航结束 -->
        <!-- banner开始 -->
        <div class="banner" style="background-image:url('http://www.feiyuewitt.com/img/fyaboutbanner.jpg?k=1576742527000')">
        ...
        <div class="banner1">
            <div class="banner1-box">
                ...
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value['1']['child'], 'b');
...
?>
              ...
              <?php if ($_smarty_tpl->tpl_vars['b']->value == 1) {?>
                                <div class="banner1-box1" style="background-color: #3b78d4;">
                                    <a href="#" class="banner1-a" style="color: #fff;"> <?php echo $_smarty_tpl->tpl_vars['b']->value['cname'];?>
</a>
                                </div>
                <?php } else { ?>
                <div class="banner1-box1">
                                        <a href="#" class="banner1-a"><?php echo $_smarty_tpl->tpl_vars['b']->value['cname'];?>
</a>
                                    </div>
                    <?php }?>
                <?php
...
<!--                <div class="banner1-box1" style="background-color: #3b78d4;">-->
<!--                    <a href="#" class="banner1-a" style="color: #fff;">集团公司简介</a>-->
<!--                </div>-->
<!--                <div class="banner1-box1">-->
<!--                    <a href="#" class="banner1-a">飞跃威特简历</a>-->
<!--                </div>-->
<!--                <div class="banner1-box1">-->
<!--                    <a href="#" class="banner1-a">飞跃之路</a>-->
<!--                </div>-->
<!--                <div class="banner1-box1">-->

<!--                    <a href="#" class="banner1-a">  荣誉资质</a>-->
...
<!--                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-img1.jpg" alt="" style="width: 100%;height: 100%;">-->
<!--                </div>-->
<!--                <div class="banner2-p">-->
<!--                    <p>-->
        ...
        <div class="banner2" style="height: 3700px;display:none;">
            <div class="banner2-box">
                ...
                <div class="banner2-img" style="float: left;margin-top: 2%;margin-left: 0.5%;margin-right: 0.5%;">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-2-img1.jpg" alt="" style="width: 100%;height: 100%;">
                </div>
                <div class="banner2-p">
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo//about-banner2-2-img2.jpg" alt="" style="width:100%;height:100%;">
                </div>
                <div class="banner2-p">
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-2-img3.jpg" alt="" style="width:100%;height:100%;">
                </div>
                <div class="banner2-p">
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-2-img4.jpg" alt="" style="width:100%;height:100%;">
                </div>
            </div>
        </div>
        <!-- banner2-2结束 -->
        ...
        <div class="banner2" style="height: 3780px;display: none;">
            <div class="banner2-box" style="height: 640px;">
                ...
                <div class="banner2-img" style="float: right;">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-3-img1.jpg" alt="">
                </div>
            ...
            <div class="banner2-box" style="margin-top: 3%;">
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-3-img2.jpg" alt="" style="width: 100%;height: 100%;">
                </div>
                <div class="banner2-p">
                    <p style="font-size:24px; line-height:36px; color:#333; text-align:left; text-indent: 1.2em; font-weight:bold;margin-top:4%;">
                        科技飞跃：
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-3-img3.jpg" alt="" style="width: 100%;height: 100%;">
                </div>
                <div class="banner2-p">
                    <p style="font-size:24px; line-height:36px; color:#333; text-align:left; text-indent: 1.2em; font-weight:bold;margin-top:4%;">
                        文化飞跃：
        ...
        <div class="banner2" style="height:708px;display:none;">
            <div class="banner2-box">
                ...
                <div class="banner2-img">
                    <img src="<?php echo APP_IMG;?>
demo/about-banner2-4-img.jpg" alt="" style="width: 100%;height: 100%;">
                </div>
            </div>
